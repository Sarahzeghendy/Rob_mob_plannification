#!/usr/bin/env python3
"""
Node pour définir l'objectif via plusieurs méthodes :
...
def interactive_mode(node):
    print("\n" + "="*60)
    print("MODE INTERACTIF - Définir l'objectif")
    print("="*60)
...
def waypoint_mode(node, waypoints_file):
    """Mode waypoints - lire depuis un fichier"""
...
def main(args=None):
    ...
    if len(sys.argv) == 1:
        ...
        try:
            ...
            # Convertir en radians si ça ressemble à des degrés
            import math
